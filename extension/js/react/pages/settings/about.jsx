	...
	constructor(props) {
		...
		this.state = {
			...
			featureList: [
				...
				this.getFeatureRow("New server button", "On the game details page the servers tab will haev a button to join a server you haven't played in yet. This feature will show up for Roblox+ Premium users only."),
