...
(function(){
	...
	$.notification.clear = request.backgroundFunction("$.notification.clear", function(){
	...
	if(ext.isBackground){
		$.notification.creationRequester = request.sent(function(data, callBack, sender){
